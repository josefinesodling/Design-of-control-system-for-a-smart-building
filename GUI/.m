function varargout = SOT(varargin)
%{
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @SOT_OpeningFcn, ...
                   'gui_OutputFcn',  @SOT_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SOT is made visible.
function SOT_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SOT (see VARARGIN)

% Choose default command line output for SOT
...
% UIWAIT makes SOT wait for user response (see UIRESUME)
...
function varargout = SOT_OutputFcn(hObject, eventdata, handles) 
